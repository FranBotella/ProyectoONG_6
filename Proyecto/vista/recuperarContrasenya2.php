      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-7 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
            ...
            <h1 class="mb-3 bread" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Cambiar contraseña</h1>
          </div>
        </div>
      </div>
    </div>
...
<div class="container text-center p-1">
      ...
      <div class="form-group">
			...
			<div id="BTNrecuperarContrasenya">
				...
				<input id="BTN-BTNrecuperarContrasenya"  TYPE="submit" NAME="brecuperarContrasenya" class='' VALUE="Confirmar"><br>
				</div>
			</div>
		</form>
	</div>
    ...
    <?php if($contrasenya!=""){ ?>
        ...
        <p>Vuelve a introducir el correo</p>
			<p> <input TYPE="text" NAME="email2" class="form-control" VALUE="" PLACEHOLDER=""></p>
    </div>
    <div class="form-group">
      <p>Minimo 8 caracteres, una letra en mayúscula y un número</p>
    <p><input TYPE="password" NAME="contraseñaNueva" class="form-control" VALUE="" PLACEHOLDER=""></p>
    </div>
    <input id="BTN-BTNuevaContrasenya"  class="" TYPE="submit" NAME="bNuevaContrasenya" VALUE="Confirmar"><br> 
    </form>  
    </div>
<?php }?>
