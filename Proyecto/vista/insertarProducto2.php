  ...
  <!-- <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    ...
    <div class="div-perfil container text-center p-1">
        <form id="insertarForm" action="index.php?ctl=insertarProducto" method="post" enctype="multipart/form-data">
            ...
            <p>Titulo</p>
			<p> <input  TYPE="text" NAME="titulo" VALUE="" PLACEHOLDER=""> <br></p>
</div>
<div class="form-group">
            <p>Contenido</p>
            <p> <textarea  name="contenido" rows="3" cols="50"></textarea></p>
</div>
            
            <div class="form-group">
            <p>Precio</p>
            <p> <input  TYPE="number" NAME="precio" VALUE="" PLACEHOLDER=""></p>
</div>
<div class="form-group">
            <p>Genero</p>
    ...
    if (isset($_POST['bAñadir'])) {
        if (($_FILES['imagen']['error'] != 0)) {
            ...
            if (empty($errors)) {
                ...
                move_uploaded_file($directorioTemp, './img/' . 'root' . '/imgTienda'.'/' .  $nameFile);
