...
document.getElementById("menuIniciarSesion2").setAttribute('class','nav-item active'); 
</script>
...
<div class="container text-center py-2">
    ...
    <div class="form-group">
		<p>Usuario</p>
		<p ><input  TYPE="text" NAME="user" class="form-control" VALUE="<?php echo $params['user'] ?>" PLACEHOLDER="" tabindex="1" aria-label="introducir nombre" > </p>
		<p>Contraseña</p>
      </div>
      <div class="form-group">
		<i>Minimo 8 caracteres, una letra en mayúscula y un número</i>	
    <!-- id="btnPSW" -->
		<p ><input  id="password2" TYPE="password" class="form-control" NAME="pass" VALUE="<?php echo $params['pass'] ?>" PLACEHOLDER="" tabindex="2" aria-label="introducir contraseña" ><img id="ojo" src="./img/ojoCerrado.png" alt=""></p>
	...
	<!-- </input> -->
			<div id="BTNregistro">
				<div class="botones">
					...
					<div>
					<p><a  role="link" href="index.php?ctl=recuperarContrasenya" tabindex="4">Cambiar contraseña</a></p>
					</div>
