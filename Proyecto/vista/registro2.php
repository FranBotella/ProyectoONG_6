...
document.getElementById("menuRegistro2").setAttribute('class','nav-item active'); 
</script>
  <!-- <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    ...
    <div class="hero-wrap" style="background-image: url('images/dg_22.jpg');" data-stellar-background-ratio="0.5">
...
<div class="container text-center py-2">
	...
	<div class="container text-center p-1">
      ...
      <div class="form-group">
			<p>Usuario</p>
			<p> <input tabindex="1" TYPE="text" class="form-control" NAME="user" VALUE="<?php echo $params['user'] ?>" PLACEHOLDER="" aria-label="introducir usuario"> </p>
      </div>
      <div class="form-group">
      <p>Contraseña</p>
			<i>Minimo 8 caracteres, una letra en mayúscula y un número</i>
			<p > <input tabindex="2" class="form-control" id="password" TYPE="password" NAME="pass" VALUE="<?php echo $params['pass'] ?>" PLACEHOLDER="" aria-label="introducir contraseña"><img id="ojo2" src="./img/ojoCerrado.png" alt=""></p>
		<!-- <input type="button" id="ojo2" value="Mostrar/ocultar contraseña"></input> -->
      </div>
      <div class="form-group">
			<p>Email</p>
			<p> <input tabindex="3" TYPE="text" class="form-control" NAME="email" VALUE="<?php echo $params['email'] ?>" PLACEHOLDER="" aria-label="introducir email"></p>
      </div>
      <div id="BTNregistro">
				<div class="botones">
					<div >
